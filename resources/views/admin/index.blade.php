...
<html>
  <head> 
    ...
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="{{asset('admindash/vendor/font-awesome/css/font-awesome.min.css')}}">
    <!-- Custom Font Icons CSS-->
    <link rel="stylesheet" href="{{asset('admindash/css/font.css')}}">
    <!-- Google fonts - Muli-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Muli:300,400,700">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{asset('admindash/css/style.default.css')}}" id="theme-stylesheet>
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="{{asset('admindash/css/custom.css')}}">
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{asset('admindash/img/favicon.ico')}}">
